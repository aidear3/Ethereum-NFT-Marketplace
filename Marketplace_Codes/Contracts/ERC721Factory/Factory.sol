...
contract ERC721 is IERC721Metadata, IERC721Receiver, IERC165 {
    ...
    address public immutable proxyContractAddr;
    ...
    constructor(
        ...
        tracker = _tracker;
        proxyContractAddr = _proxyContractAddr;
    }
    ...
    function transferFrom(address _from, address _to, uint _tokenId) public {
        ...
        if (msg.sender != proxyContractAddr) {
...
contract NFTCollection is ERC721 {
    constructor(
        ...
        ITracker _tracker,
        address _proxyContractAddr
    ) ERC721(_collectionName, _collectionSymbol, _collectionDescription, _owner, _tracker, _proxyContractAddr) {
        //
    }
}
