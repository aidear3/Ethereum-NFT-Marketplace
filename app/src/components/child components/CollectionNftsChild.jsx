...
const CollectionNftsChild = ({ nftName, nftDesc, nftImg, nftId, nftMintedTime, nftAddress }) => {
    ...
    const getCopyData = useCallback(() => {
        const Data = {
            ...
            nftImg,
            nftId,
            nftMintedTime: (new Date(nftMintedTime)).toLocaleString(), nftAddress
        };
...
export default CollectionNftsChild;